...
# --------------------------------------First Panel-----------------------------------------
		...
		self.start = wx.Button(self.begin, label="Start", pos=(375,225))
		self.start.Bind(wx.EVT_BUTTON, self.OnStart)
		
		self.SATFond = wx.Font(40, wx.DECORATIVE, wx.NORMAL, wx.BOLD)
		self.numberFond = wx.Font(60, wx.DECORATIVE, wx.NORMAL, wx.BOLD)

		self.SAT = wx.StaticText(self.begin, label = "Cracking SAT vocabulary", pos=(0,0))
		self.SAT.SetFont(self.SATFond)
		
		self.number = wx.StaticText(self.begin, label = "5000+", pos=(0,0))
